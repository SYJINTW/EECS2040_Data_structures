...
int main() {
    try {
        ...
        Matrix Mcopy(M1);
        clock_t end = clock();
        double computingTime = double(end - start)/CLOCKS_PER_SEC;
        cout << "The copy of M1 by using copy constructor: " << Mcopy;
        cout << "Computing time of copy constructor: " << computingTime << " seconds.\n";
        while (1) {
